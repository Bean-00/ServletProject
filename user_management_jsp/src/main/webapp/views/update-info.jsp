		...
		<form class="form" action="/views/submit-info.jsp" method="POST">
						...
						<td colspan="3">
							<div class="d-flex">
								<input class="form-input" type="text" name="birth-year"
									id="year-input" style="width: 100px" value="<%= userVO.getBirthDateString().split("년")[0] %>"> 년 <select
			...
			<div class="d-flex" style="justify-content: center">
				<button name="updateInfo" type='submit'
					style="padding: 15px 20px; margin-top: 30px;">내 정보 수정하기</button>
			</div>
			<a href='/views/success-login.jsp'>로그인 화면으로 돌아가기</a>
		</form>
